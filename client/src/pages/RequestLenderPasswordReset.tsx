...
export default function RequestLenderPasswordReset() {
  ...
  const requestMutation = useMutation({
    mutationFn: async (data: RequestFormData) => {
      const response = await apiRequest('POST', '/api/lenders/request-password-reset', data);
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Card className="p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Reset Lender Password</h1>
            <p className="text-muted-foreground">
              Enter your lender account email and we'll send you a link to reset your password.
            </p>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground mb-4">
                    If a lender account exists with that email, we've sent password reset instructions.
                  </p>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Lender Email Address</FormLabel>
                      <FormControl>
                        <Input
                          type="email"

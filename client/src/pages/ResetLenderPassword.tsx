...
import { CheckCircle2, Lock, Building2, Eye, EyeOff } from "lucide-react";
...
export default function ResetLenderPassword() {
  ...
  return (
    <Layout>
      <SEO title="Set New Lender Password" description="Set a new password for your RE Data Metrix lender account." noIndex={true} />
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Card className="p-8">

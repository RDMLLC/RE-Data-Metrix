...
import { Users, Building2, BarChart3, LogOut, Key, Gift, Ticket, Plug, CheckCircle, AlertCircle, Loader2, Handshake, Calculator, Database, AlertTriangle, Video, Monitor, RefreshCw, Link2, Code, HardHat, Target, Eye, Mail, MessageSquare, Bug, LineChart } from "lucide-react";
      ...
      <div className="min-h-[calc(100vh-16rem)] py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => setLocation("/admin/auditor-invites")}
                      data-testid="button-auditor-invites"
                    >
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                      ...
                      data-testid="button-marketing-dashboard"
                    >
            ...
            <Card 
              className="hover-elevate cursor-pointer" 
              onClick={() => setLocation("/admin/user-submissions")}
              data-testid="card-user-submissions"
            >
              <CardHeader>
                <div className="flex items-center gap-3">
              ...
              <CardContent>
                <CardDescription>
                  View bug reports and feature suggestions from members
                </CardDescription>
              </CardContent>
            </Card>

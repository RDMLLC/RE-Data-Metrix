...
const YOUTUBE_ID = "WkuAgslCrrM";
const YOUTUBE_EMBED = `https://www.youtube.com/embed/${YOUTUBE_ID}?rel=0&modestbranding=1&autoplay=1`;
...
function VideoFacade() {
  ...
  return (
    <div
      className="relative aspect-video bg-black rounded-xl overflow-hidden shadow-2xl border-2 border-white/20 cursor-pointer group"

...
const PLACEHOLDER_AFFILIATES: Affiliate[] = [
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["comps", "lead-generation", "deal-analysis"],
    features: [],
    iconName: "Search",
    referralFee: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["direct-mail", "marketing-automation", "list-building"],
    features: [],
    iconName: "Mail",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["skip-tracing", "list-building", "lead-generation"],
    features: [],
    iconName: "Search",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["deal-analysis", "rehab-cost-estimating", "comps"],
    features: [],
    iconName: "Calculator",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["mobile-app", "crm", "deal-analysis"],
    features: [],
    iconName: "Smartphone",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["marketing-automation", "sms", "direct-mail"],
    features: [],
    iconName: "Zap",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["rehab-cost-estimating", "project-management"],
    features: [],
    iconName: "Hammer",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["website-landing-page", "lead-generation", "marketing-automation"],
    features: [],
    iconName: "Globe",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["virtual-driving", "driving-for-dollars", "comps"],
    features: [],
    iconName: "Map",
    referralFee: null,
    referralFeeType: null,
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["sms", "marketing-automation", "lead-generation"],
    features: [],
  ...
  },
  {
    ...
    loginUsername: null,
    loginPassword: null,
    categories: ["crm", "deal-analysis", "marketing-automation", "team-collaboration", "lead-generation"],
    features: [],
    iconName: "Briefcase",
    referralFee: null,
    referralFeeType: null,

...
const loanTypes: LoanType[] = [
  {
    ...
    buttonText: "Find Hard Money / Bridge Lenders",
  ...
  },
  {
    ...
    creditScore: "No credit check required",
    description: "Ultra-short-term financing for same-day or back-to-back closings. Provides 100% financing for wholesale deals where you buy and immediately resell a property. Note: Almost exclusively for wholesale deals, though some lenders can help if your loan needs just 1-2 days.",
    buttonText: "Find Transactional Funding Lenders",
    loanTypeFilter: "transactional",
  },
  {
    title: "Private/Seller Financing",
  ...
  },
  {
    ...
    buttonText: "Find Balloon Lenders",
    loanTypeFilter: "balloon",
  },
  {
    title: "5/1 ARM (Adjustable-Rate Mortgage)",

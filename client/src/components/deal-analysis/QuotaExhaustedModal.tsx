      ...
      <DialogContent className="sm:max-w-md" data-testid="modal-quota-exhausted">
        <DialogHeader>
          <DialogTitle className="text-xl text-center">
            Automated Analysis Limit Reached
          </DialogTitle>
          <DialogDescription className="text-center">
            You've used your automated deal analysis entries for this period.
          </DialogDescription>
        </DialogHeader>
          ...
          {isAuthenticated ? (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-semibold">Switch to Manual Entry</div>

import type { LoanComparisonColumn } from "../schema";
import type { DrawSchedule, LoanCalculation } from "../schema";
...
export function createCashSaleColumn(dealInputs: DealInputs): LoanComparisonColumn {
  ...
  const outOfPocketBreakdown: OutOfPocketBreakdown = {
    downPayment: cashMetrics.totalProjectCost,
...
export function createLoanComparisonColumn(
  ...
  return {
    ...
    closingCostsBuy: loanCalculation.totalClosingCostsBuy,
